...
public record SearchOutputDto(long id, long latitude, long longitude, String name, String description, LocalDate start, LocalDate end, List<ArtistParticipationDto> featuredArtists, float distance, EventType eventType, List<ArtTag> tags, String image) {
}
